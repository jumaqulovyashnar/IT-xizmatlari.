  ...
  ru: {
    ...
    threeSections: {
      ...
      section3: {
        ...
        features: [
          { title: "Маркетинговая структура AIDA", desc: "Привлечение внимания клиентов и психология конверсии." },
          { title: "Google PageSpeed 99/100", desc: "Ультрабыстрая загрузка за 1-2 секунды и высокая конверсия." },
          { title: "Интеграция с Telegram и CRM", desc: "Мгновенное получение заявок и лидов прямо в ваш Telegram." },
          { title: "100% Адаптивный Дизайн", desc: "Идеальное отображение на смартфонах, планшетах и компьютерах." },
          { title: "SEO и Рекламная Готовность", desc: "Полная оптимизация под поисковики Google, Яндекс и пиксели рекламы." }
        ],
